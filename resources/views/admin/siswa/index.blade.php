          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <input required="" type="text" name="wali_siswa" id="wali_siswa" class="form-control">
              </div>
            </div>
            <div class="col-lg-3">
              <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label for="wali_siswa_edit">Wali Siswa:</label>
                <input required="" type="text" name="wali_siswa" id="wali_siswa_edit" class="form-control">
              </div>
            </div>
            <div class="col-lg-4">
              <div class="form-group">
