...
<head>
  ...
  <!-- layouts keseluruhan -->
  <link rel="stylesheet" href="{{ asset('templates/backend/AdminLTE-3.1.0') }}/layouts/layout.css">
  @stack('css')
</head>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ date('Y') }} <a href="">SPP SD Batu Bara</a>.</strong>
    All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
